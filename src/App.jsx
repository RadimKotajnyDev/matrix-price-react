    ...
    */
    ...
    return (
        <div className="text-center mt-10 text-xl">
            <h1 className="underline underline-offset-8 decoration-1 font-bold">Price Matrix Forms</h1>
            <div className="m-5 border-2 rounded-lg w-fit shadow-2xl ml-auto mr-auto block px-5">
                ...
                <div className="grid md:grid-cols-5 border-2 mt-5">
                    <Field />
                    <Operator />
                    <Value />
                    <AddOrRemove />
                ...
                <div className="grid grid-flow-col ml-[30vw] mr-[30vw]">
                    ...
                    <div className="m-5">
                        ...
                        className="w-fit font-light cursor-pointer border-2 p-2 px-10 uppercase bg-white text-black rounded-xl hover:bg-slate-900 hover:text-white duration-700" />
                    </div>
                </div>
            </div>
        </div>
