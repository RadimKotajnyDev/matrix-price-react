...
function App() {
    return (
        <div className="text-center mt-10 font-Inter text-3xl">
            ...
            <p className="font-thin text-sm p-2 text-white bg-black m-2 rounded-lg w-fit mt-5 ml-auto mr-auto block">Improve this page as you wish.</p>
            <div className="m-12 border-2 rounded-lg shadow-xl w-fit ml-auto mr-auto block px-5">
                <form className="max-w-lg m-5 p-2 ml-auto mr-auto block">
                    <div className="flex flex-wrap -mx-3 mb-6">
                        ...
                        <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="" type="text" placeholder="..." />
                        ...
                        <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="" type="text" placeholder="..." />
                        </div>
                    </div>
