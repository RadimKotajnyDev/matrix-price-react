...
//
//   const rulesets = Convert.toRulesets(json);
//
...
export class Converts {
    public static toRulesets(json: string): Rulesets[] {
        return cast(JSON.parse(json), a(r("Rulesets")));
    }

    public static rulesetsToJson(value: Rulesets[]): string {
        return JSON.stringify(uncast(value, a(r("Rulesets"))), null, 2);
    }
}
